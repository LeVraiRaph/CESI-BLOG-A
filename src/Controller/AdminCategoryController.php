...
class AdminCategoryController extends AbstractController{
    ...
    public function List(){
        $categorytManager = new CategoryManager(Bdd::getInstance());
        $categoryList = $categorytManager->getAll();
        echo $this->twig->render('AdminCategory/list.html.twig',[
            'listCategorie' => $categoryList
        ]);
    ...
    public function Delete($id){
        if($id<>''){
            $categoryManager = new CategoryManager(Bdd::getInstance());
            $post = $categoryManager->get($id);
